...
describe('Button', () => {
  describe('The Button component', () => {
    ...
    it('renders the correct text', () => {
      ...
      // Act
      // Assert
      expect(screen.getByTestId('button')).toHaveTextContent(`${mockButtonProps.title}`);
    });
    ...
    it('has the correct class name when the type is OUTLINE', () => {
      // Arrange
      render(<Button {...mockButtonProps} type={EButtonType.OUTLINE} />);
      // Act
      // Assert
      expect(screen.getByTestId('button')).toHaveClass(getButtonTypeClassName(EButtonType.OUTLINE));
    });

    it('has the correct class name when the type is SECONDARY', () => {
      // Arrange
      render(<Button {...mockButtonProps} type={EButtonType.SECONDARY} />);
      // Act
      // Assert
      expect(screen.getByTestId('button')).toHaveClass(getButtonTypeClassName(EButtonType.SECONDARY));
    });
