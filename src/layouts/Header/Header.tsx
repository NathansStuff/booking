...
import { EHeaderPages } from './HeaderTypes';
  ...
  /* <header>
      ...
      >
        ...
        <div className='hidden w-full md:flex md:items-center md:w-auto' id='menu'>
          ...
          >
            <li>
              <HeaderElement active={active === EHeaderPages.ABOUT} link='/' title='About' />
            </li>
            <li>
              <HeaderElement active={active === EHeaderPages.SERVICES} link='/' title='Services' />
            </li>
            <li>
              <HeaderElement active={active === EHeaderPages.BLOG} link='/' title='Blog' />
            </li>
            <li>
              <HeaderElement active={active === EHeaderPages.FAQ} link='/' title='FAQ' />
            </li>
            <li>
              <HeaderElement active={active === EHeaderPages.CONTACT} link='/' title='Contact' />
            </li>
            <li>
              <a className='md:p-4 py-2 block hover:text-purple-400 text-purple-500' href='#'>
